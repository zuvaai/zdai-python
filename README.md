...
DocAI will return the normalized values for fields that have a `normalization_type` of `DATE`, `CURRENCY` and `DURATION`.  
...
values of the text that was extracted by DocAI.
